...
export default function BarViz({
    ...
    // spacing tuned for 5..100 elements: avoids crushed bars or giant gaps
    ...
    // labels: target ~28 captions across width, but clamp so tiny sets still show values nicely
    const MAX_LABELS = 28
    ...
    const labelStyle = useMemo(() => ({
        ...
        height: 32,               
        lineHeight: '27px',       // match height for perfect vertical centering
            ...
            <CardContent sx={{ p: 3, pt: 0 }}>
                ...
                <div
                    ...
                    style={{
                        ...
                        padding: 24,
                        // subtle grid for scale; non-intrusive
                        backgroundImage:
