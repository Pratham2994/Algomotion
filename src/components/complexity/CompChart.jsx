...
// Custom tooltip to enforce overlay hierarchy on top
function CustomTooltip({ active, payload, label }) {
    if (!active || !payload || !payload.length) return null

    // Keep original order index for non-overlay series to preserve user-facing consistency
    ...
    const sorted = withIndex.sort((a, b) => {
        ...
        // same rank (both non-overlays) — keep original order
...
export default function CompChart({
    ...
    // NEW: quick controls synced with top panel
    onRun, onReset
}) {
    return (
