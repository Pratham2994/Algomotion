          ...
          <Grid container spacing={3}>
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <FormControl fullWidth size="medium">
                ...
                <Select
                  labelId="algo" label="Algorithm" value={algo} onChange={e => setAlgo(e.target.value)}
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <FormControl fullWidth size="medium">
                ...
                <Select
                  labelId="mode" label="Mode" value={mode} onChange={e => setMode(e.target.value)}
                  sx={{ '& .MuiSelect-select': { color: '#e2e8f0' }, '& .MuiOutlinedInput-notchedOutline': { borderColor: '#374151' } }}
                >
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <Box>
                ...
                <Slider
                  value={obst} min={0} max={0.5} step={0.01} onChange={(_, v) => setObst(v)} disabled={mode !== 'open'}
                  sx={{
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <Box>
                ...
                <Slider
                  value={braid} min={0} max={0.5} step={0.01} onChange={(_, v) => setBraid(v)} disabled={mode !== 'maze'}
                  sx={{
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <Box>
                ...
                <Slider
                  value={rows} min={9} max={51} step={2} onChange={(_, v) => setRows(v)}
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <Box>
                ...
                <Slider
                  value={cols} min={9} max={73} step={2} onChange={(_, v) => setCols(v)}
                  sx={{ '& .MuiSlider-track': { backgroundColor: '#67e8f9' }, '& .MuiSlider-thumb': { backgroundColor: '#67e8f9' }, '& .MuiSlider-rail': { backgroundColor: '#374151' } }}
                />
              </Box>
            </Grid>
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <Box>
                ...
                <Slider
                  value={speed} min={0.25} max={100} step={1} onChange={(_, v) => setSpeed(v)}
                  sx={{ '& .MuiSlider-track': { backgroundColor: '#67e8f9' }, '& .MuiSlider-thumb': { backgroundColor: '#67e8f9' }, '& .MuiSlider-rail': { backgroundColor: '#374151' } }}
                />
              </Box>
            </Grid>
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <FormControl fullWidth size="medium">
                ...
                <Select
                  labelId="heur" label="A* Heuristic" value={astarHeur} onChange={e => setAstarHeur(e.target.value)} disabled={algo !== 'astar'}
                  sx={{ '& .MuiSelect-select': { color: '#e2e8f0' }, '& .MuiOutlinedInput-notchedOutline': { borderColor: '#374151' } }}
                >
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <div className="flex flex-col gap-3">
                <Button
                  variant="outlined" startIcon={<ShuffleRoundedIcon />} onClick={randomize} fullWidth
                  sx={{ borderColor: '#67e8f9', color: '#67e8f9', '&:hover': { borderColor: '#22d3ee', color: '#22d3ee' } }}
                >
                  New Grid
                </Button>
