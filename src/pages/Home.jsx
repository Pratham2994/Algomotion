  ...
  return (
    <div className="space-y-10">
        ...
        <div className="flex flex-col gap-6">
          <div>
            ...
            <p className="text-slate-300 mt-3 leading-relaxed">
              Interactive, step-by-step visuals for <span className="text-slate-100">Sorting</span> and{' '}
              <span className="text-slate-100">Pathfinding</span> algorithms, plus a hands-on{' '}
              <span className="text-slate-100">Complexity Explorer</span>. Tune parameters, watch clean
              animations, and read clear metrics that line up with Big-O.
            </p>
          </div>
        </div>
      </motion.section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <FeatureCard
          icon={<QueryStatsIcon sx={{ fontSize: 24 }} />}
          ...
          bullets={[
            ...
            'Measured times vs Big-O overlays',
          ]}
          to="/complexity"
          cta="Open Explorer"
        />
        ...
        <FeatureCard
          ...
          bullets={[
            'Concise notes + Big-O tables',
            'Clear pseudocode & gotchas',
            'Tiny inline mini-demos',
          ]}
          to="/library"
          cta="Open Library"
        />
